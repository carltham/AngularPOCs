...
@Component({
  template: `<div colorDirective>Testing, testing ... 123</div>
    <div colorDirective>Testing, testing ... 123</div>`,
})
class TestHoverFocusComponent {}

describe('Directive: colorDirective', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [TestHoverFocusComponent, colorDirective],
    });
  ...
  it('testing directive, should change oldBackgroundColor only when hovering over it', () => {
    let directive0 = element0.injector.get(colorDirective) as colorDirective;
    let directive1 = element1.injector.get(colorDirective) as colorDirective;
