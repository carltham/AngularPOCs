...
(function (factory) {
  ...
  $.widget = function (name, base, prototype) {
    ...
    $.expr[":"][firstName.toLowerCase()] = function (elem) {
      return !!$.data(elem, firstName);
    };
  ...
  $.widget.bridge = function (name, object) {
    var firstName = object.prototype.widgetFullName || name;
    $.fn[name] = function (options) {
      ...
      if (isMethodCall) {
        ...
        if (!this.length && options === "instance") {
          ...
          this.each(function () {
            var methodValue;
            var instance = $.data(this, firstName);
        ...
        this.each(function () {
          ...
          if (instance) {
            ...
            $.data(this, firstName, new object(options, this));
          }
        });
      }
